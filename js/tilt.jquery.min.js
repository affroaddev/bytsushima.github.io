!function(t) {
    "function" == typeof define && define.amd ? define(["jquery"], t) : "object" == typeof module && module.exports ? module.exports = function(i, s) {
    ...
    return t.fn.tilt = function(i) {
        const s = function() {
            this.ticking || (requestAnimationFrame(l.bind(this)),
            this.ticking = !0)
        }
          , e = function() {
          ...
          , l = function() {
            if (this.transforms = o.call(this),
            this.reset)
                return this.reset = !1,
